 ...
 ***********************************************************************
 *                                                                     *
 * true to enable or false to disable endstop pullup resistors         *
 *                                                                     *
 ***********************************************************************/
 ...
 ***********************************************************************
 *                                                                     *
 * Enable this feature if all enabled endstop pins are                 *
 * interrupt-capable, this will remove the need to poll the interrupt  *
 * pins, saving many CPU cycles.                                       *
 *                                                                     *
 ***********************************************************************/
 ...
 * could be used and deactivated after their use.                      *
...
// For example an inductive probe.
...
// TODO check if they are needed maybe for BLTOUCH
// Before deploy/stow pause for user confirmation
//#define PAUSE_BEFORE_DEPLOY_STOW

// Probe Raise options.
// Provide clearance for the probe to deploy, stow, and travel.
// Z position for the probe to deploy/stow
#define Z_PROBE_DEPLOY_HEIGHT 15
// Z position for travel between points
...
// Enable if probing seems unreliable. Heaters and/or fans - consistent
// with options selected below - will be disabled during probing so as 
// to minimize potential EM interference by quieting/silencing the source 
// of 'noise' (generated by changes in current flowing through the wires).
// This is likely most useful to users of the BLTouch probe, but may also
// help those with inductive or other probe types.
 ...
 ************************************************************************
 *                                                                      *
 * (in mm) Minimal z height before homing (G28) for Z clearance above   *
 * the bed, clamps, etc *
 ...
 * Change if an axis goes the wrong way.                                *
 * It is better to reverse the motor connector                          *
 ************************************************************************/
 ...
 *   benefits of other systems. UBL also includes integrated            *
 *   Mesh Generation, Mesh Validation and Mesh Editing systems.         *
 *                                                                      *
 * - LINEAR                                                             *
...
// (mm) Default layer height for the G26 Mesh Validation Tool.
#define MESH_TEST_LAYER_HEIGHT   0.2
// (c)  Default nozzle temperature for the G26 Mesh Validation Tool.
...
// When nozzle is off the mesh, this is used as Z-Height correction value.
//#define UBL_Z_RAISE_WHEN_OFF_MESH 2.5
/** END UNIFIED BED LEVELING **/

/** START MESH BED LEVELING or ABL LINEAR or ABL BILINEAR or UBL **/
// Set the number of grid points per dimension
#define GRID_MAX_POINTS_X 3
#define GRID_MAX_POINTS_Y 3
/** END MESH BED LEVELING or ABL LINEAR or ABL BILINEAR or UBL **/

/** START ABL LINEAR or ABL BILINEAR **/
...
/** END ABL LINEAR or ABL BILINEAR **/

/** START ABL_3POINT or UBL **/
...
// Manually set home position. Leave undefined for automatic settings.
 ...
 *                                                                      *
 ************************************************************************/
// Default steps per unit               X,  Y,    Z,  E0,  E1,  E2,  E3
...
// planner plans for at the end of the buffer and all stops.
...
//  Maximum acceleration in mm/s^2 for retracts
//                                       E0,    E1,    E2,    E3
 ...
 * When changing speed and direction, if difference is less than this   *
...
/************************************************************************
 *               Hotend offset (in mm) for each hotend                  *
 ************************************************************************
 *                                                                      *
 * Offset of the hotends                                                *
 * (if using more than one and relying on firmware to position hotend   *
 * when changing).                                                      *
 ...
 * direction to compensate any mechanical hysteresis your printer       * 
 * may have.                                                            *
